...
from unc_extractor import ViTExtractor
...
def image_depth_callback(image_msg, depth_msg):
    ...
    with torch.no_grad():
        ...
        seg_masks, pil_images, centroids, pos_centroids, clustered_arrays, unc = find_cosegmentation_ros(extractor, saliency_extractor, ims_pil, args.elbow, args.load_size, args.layer,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', default='unc_vits8', type=str,
                        help="""type of model to extract. 
                           Choose from [dino_vits8 | dino_vits16 | dino_vitb8 | dino_vitb16 | vit_small_patch8_224 | 
                           vit_small_patch16_224 | vit_base_patch8_224 | vit_base_patch16_224 | unc_vits8]""")
    ...
    extractor = ViTExtractor("unc_vits8", 8, device=device)
    ...
    cam_info_topic = "/kitti/camera_color_left/camera_info"
    ...
    image_topic = "/kitti/camera_color_left/image"
