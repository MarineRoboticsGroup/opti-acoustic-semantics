...
def image_sonar_callback(image_msg, sonar_msg):
    ...
    with torch.no_grad():
        ...
        seg_masks, img_out, centroids, centroids_umap384_1, centroids_umap384_3, pos_centroids  = maskcut_demo(None, ims_pil, backbone, args.patch_size, 
    ...
    centroids_umap384_1_msg = ObjectsVector()
    centroids_umap384_1_msg.header = image_msg.header
    ...
    for i, pos_cent in enumerate(pos_centroids):
        ...
        if range:
            ...
            x, y, z = unproject(x_pix, y_pix, range, K)
            print(x, y, z)
            centroid_umap384_1_msg = ObjectVector()
            centroid_umap384_1_msg.geometric_centroid.x = x
            centroid_umap384_1_msg.geometric_centroid.y = y
            centroid_umap384_1_msg.geometric_centroid.z = z
            centroid_umap384_1_msg.latent_centroid = list(centroids_umap384_1[i])
            
            centroids_umap384_1_msg.objects.append(centroid_umap384_1_msg)
        
    # publish 3D positions of cluster centroids

    cluster_umap384_1_pub.publish(centroids_umap384_1_msg)


    centroids_umap384_3_msg = ObjectsVector()
    centroids_umap384_3_msg.header = image_msg.header
    ...
    for i, pos_cent in enumerate(pos_centroids):
        ...
        if range:
            ...
            x, y, z = unproject(x_pix, y_pix, range, K)
            print(x, y, z)
            centroid_umap384_3_msg = ObjectVector()
            centroid_umap384_3_msg.geometric_centroid.x = x
            centroid_umap384_3_msg.geometric_centroid.y = y
            centroid_umap384_3_msg.geometric_centroid.z = z
            centroid_umap384_3_msg.latent_centroid = list(centroids_umap384_3[i])
            
            centroids_umap384_3_msg.objects.append(centroid_umap384_3_msg)
        
    # publish 3D positions of cluster centroids

    cluster_umap384_3_pub.publish(centroids_umap384_3_msg)
...
if __name__ == "__main__":
    ...
    cluster_umap384_1_pub = rospy.Publisher("/camera/objects_umap384_1", ObjectsVector, queue_size=10)
    cluster_umap384_3_pub = rospy.Publisher("/camera/objects_umap384_3", ObjectsVector, queue_size=10)
