...
if __name__ == "__main__":
    ...
    parser.add_argument('--patch-size', type=int, default=14, choices=[14, 8], help='patch size')
    ...
    parser.add_argument('--fixed_size', type=int, default=448, help='rescale the input images to a fixed size')
